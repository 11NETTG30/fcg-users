...
public static class DocumentationConfiguration
{
    ...
    extension(WebApplication app)
    {
        public void UseDocumentation()
        {
            ...
            {
                options.SwaggerEndpoint("/openapi/v1.json", "FCG Users API v1");
                options.DocumentTitle = "FCG Users - Documentação da API";
    ...
    private sealed class InfoDocumentationTransformer : IOpenApiDocumentTransformer
    {
        ...
        )
        {
            ...
            {
                Title = "FCG Users - Serviço de Usuários",
                Version = "v1",
                Description = """
                    API de Usuários para plataforma de jogos desenvolvida como projeto de pós-graduação em Arquitetura de Sistemas .NET.
                ...
                {
                    Name = "11NETTG30",
                    Url = new Uri("https://github.com/11NETTG30/fcg-users")
                }
            };
