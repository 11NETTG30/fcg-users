...
namespace FCG.Users.BDDTests.Identidade.Logout
{
    ...
    public partial class LogoutFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("pt-BR"), "Identidade/Logout", "Logout", "  Para encerrar a sessão do usuário\n  Como sistema\n  Quero invalidar o refresh to" +
                "ken no logout", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Identidade/Logout/Logout.feature.ndjson", 4);
        }
